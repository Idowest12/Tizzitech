      ...
      >
        ...
        <div className="p-6 md:p-8 overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button 
                    type="submit"
                    disabled={loading || googleLoading || resetSent}
                    className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-medium rounded-xl shadow-lg shadow-blue-500/25 transition-all active:scale-[0.98] disabled:opacity-70 mt-6 flex justify-center items-center"
                >
                    {loading ? (
                      <>
            ...
            <div className="mt-6 flex justify-center w-full min-h-[44px]">
                {googleLoading ? (
                    <div className="flex items-center justify-center space-x-3 w-full py-2 bg-neutral-800/50 rounded-xl text-neutral-300 border border-neutral-700">
